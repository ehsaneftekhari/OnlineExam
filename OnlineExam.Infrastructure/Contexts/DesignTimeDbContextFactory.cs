...
namespace OnlineExam.Infrastructure.Contexts
{
    internal class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<OnlineExamContext>
    {
        public OnlineExamContext CreateDbContext(string[] args)
        {
            ...
            builder.UseSqlServer("data source=EHSANVIVOBOOK\\EHSANSQLSERVER;initial catalog=data source=EHSANVIVOBOOK\\EHSANSQLSERVER;initial catalog=OnlineExam;integrated security=true;integrated security=true");
